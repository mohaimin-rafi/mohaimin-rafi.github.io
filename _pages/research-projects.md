---
layout: archive
title: "Research & Project Involvements"
...
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Manuscript PDF](/files/Electro_Thermo_Mechanical_Coupling_Manuscript.pdf)  
...
### 📄 <a href="/files/Landfill_Gas_to_Energy_Paper.pdf" target="_blank">Assessment of Landfill Gas-to-Energy Potential and Technologies at Arefin Nagar and Fatehabad Landfills Using Site-Specific LandGEM Modeling</a>
**Authors:** Pritam Biswangri, Ayan Chowdhury, Amitav Mandal, **Mohammad Abdul Mohaimin**  
**Venue:** 8th International Conference on Chemical Engineering (ICCHE 2026), BUET (2026)  
**Status:** Accepted for Presentation (Presentation at December 2026)  
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Conference Paper PDF](/files/Landfill_Gas_to_Energy_Paper.pdf)  
...
### 📄 <a href="/files/Undergraduate_Thesis_Presentation.pdf" target="_blank">Multiphysics Modeling of Hybrid Laminated Composite Conductors Under a DC Field</a>
**Duration:** Nov 2023 – Mar 2025  
**Supervisor:** Dr. Shaikh Reaz Ahmed, Professor, Dept. of Mechanical Engineering, BUET  
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Presentation PDF](/files/Undergraduate_Thesis_Presentation.pdf)  
...
* **Key Contributions & Methodology:**
  * Formulated governing equations and numerical model for hybrid laminated composite conductors, introducing a Displacement Potential Function approach that reduces the 3-variable mechanical equilibrium equations to a single, solvable 4th-order PDE.
  * Implemented Finite Difference Method (FDM) with iterative solvers to solve the fully coupled electro-thermo-mechanical system, incorporating non-linear, temperature-dependent material properties.
  * Developed and optimized computational code in MATLAB, validating voltage, temperature, and stress-profile results against COMSOL Multiphysics.
  * Applied core expertise: numerical methods (FDM, iterative solvers), multiphysics modeling, classical lamination theory, heat transfer, and MATLAB programming.

---

## Academic Engineering Projects

### 📄 <a href="/files/Heat_Exchanger_Presentation.pdf" target="_blank">Design, Fabrication, and CFD Analysis of a Double-Pipe Heat Exchanger with Disc-Type Turbulator and Outside Fins</a>
**Course:** ME 310: Heat Equipment Design Sessional, Department of Mechanical Engineering, BUET | Jul 2023 – Sept 2024  
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Presentation PDF](/files/Heat_Exchanger_Presentation.pdf)  
...
### 📄 <a href="/files/UAV_Mosquito_Detection_Presentation.pdf" target="_blank">Autonomous Detection of Potential Mosquito Breeding Sites Using UAVs and Computer Vision</a>
**Course:** ME 366: Instrumentation and Measurement Lab, Department of Mechanical Engineering, BUET | Nov 2022 – Mar 2023  
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Presentation PDF](/files/UAV_Mosquito_Detection_Presentation.pdf)  
...
### 📄 <a href="/files/Landfill_Methane_Feasibility_Presentation.pdf" target="_blank">Mitigation and Utilization of Methane Emissions from Landfills of Dhaka: Waste-to-Energy Feasibility Study</a>
**Course:** ME 413: Energy and Environment, Department of Mechanical Engineering, BUET | 2023 – Dec 2024  
**Resources:** [<i class="fas fa-file-pdf"></i> View / Download Presentation PDF](/files/Landfill_Methane_Feasibility_Presentation.pdf)  
